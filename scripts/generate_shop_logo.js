...
<head>
    <meta charset="UTF-8">
    <title>FonzKart Printable Shop Logo Banners</title>
...
<body>
    ...
    <div class="page light">
                ...
                <div class="gadget-cluster">
                    ...
                    <div class="phone-wrapper">
                        <svg viewBox="0 0 32 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 100%;">
                            ...
                            <g clip-path="url(#phone-screen-clip-light)">
                                <image
                                    x="3.25"
                                    y="17.25"
                                    width="25.5"
                            ...
                            <defs>
                                <clipPath id="phone-screen-clip-light">
        ...
        <div class="wordmark-container">
            ...
            <div class="logo-phone">
                <svg viewBox="0 0 32 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 100%;">
                    ...
                    <rect x="2.2" y="2.2" width="27.6" height="55.6" rx="4" fill="#000000" />
                    <rect x="3" y="3" width="26" height="54" rx="3.2" fill="#35aa67" />
                    <g clip-path="url(#logo-phone-clip-light)">
                        <image
                            x="3.25"
                            y="17.25"
                            width="25.5"
                    ...
                    <defs>
                        <clipPath id="logo-phone-clip-light">
                            <rect x="3" y="3" width="26" height="54" rx="3.2" />
                        </clipPath>
                    </defs>
                </svg>
        ...
        <div class="badge">Light Print Version</div>
    </div>

    <!-- PAGE 2: DARK THEME BANNER -->
    <div class="page dark">
        <!-- 1. Cart Logo Composition -->
        <div class="cart-logo-container">
            <div class="cart-wrapper">
                ...
                <div class="gadget-cluster">
                    ...
                    <div class="phone-wrapper">
                        <svg viewBox="0 0 32 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 100%;">
                            ...
                            <rect x="2.2" y="2.2" width="27.6" height="55.6" rx="4" fill="#000000" />
                            <rect x="3" y="3" width="26" height="54" rx="3.2" fill="#35aa67" />
                            <g clip-path="url(#phone-screen-clip-dark)">
                                <image
                                    x="3.25"
                                    y="17.25"
                                    width="25.5"
                            ...
                            <defs>
                                <clipPath id="phone-screen-clip-dark">
                                    <rect x="3" y="3" width="26" height="54" rx="3.2" />
                                </clipPath>
                            </defs>
                        </svg>
        ...
        <div class="wordmark-container">
            ...
            <div class="logo-phone">
                <svg viewBox="0 0 32 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 100%;">
                    ...
                    <rect x="2.2" y="2.2" width="27.6" height="55.6" rx="4" fill="#000000" />
                    <rect x="3" y="3" width="26" height="54" rx="3.2" fill="#35aa67" />
                    <g clip-path="url(#logo-phone-clip-dark)">
                        <image
                            x="3.25"
                            y="17.25"
                            width="25.5"
                    ...
                    <defs>
                        <clipPath id="logo-phone-clip-dark">
                            <rect x="3" y="3" width="26" height="54" rx="3.2" />
                        </clipPath>
                    </defs>
                </svg>
        ...
        <div class="badge">Dark Print Version</div>
    </div>
...
// Save the HTML locally in public folder
const htmlPath = path.join(__dirname, '../public/shop_logo_printable.html');
fs.writeFileSync(htmlPath, htmlContent);
console.log('HTML template written to public/shop_logo_printable.html');

// Run Puppeteer to compile the PDF
async function run() {
    ...
    await page.setViewport({
        width: 1400,
        height: 800, // accommodate both pages in layout
        deviceScaleFactor: 2 // high-resolution rendering
    });
    
    console.log('Navigating to generated HTML file...');
    await page.goto('file://' + htmlPath, { waitUntil: 'networkidle0' });
    
    console.log('Printing to PDF...');
    const pdfPath = path.join(__dirname, '../public/shop_logo_printable.pdf');
    ...
    console.log('PDF printed successfully to public/shop_logo_printable.pdf');
    await browser.close();
}
