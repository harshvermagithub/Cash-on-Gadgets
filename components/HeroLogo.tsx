...
const SmartphoneSVG = () => (
    <svg width="100%" height="100%" viewBox="0 0 32 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="30" height="58" rx="4" fill="#0f172a" stroke="#334155" strokeWidth="1.5" />
...
const RupeeNoteSVG = () => (
    <svg width="100%" height="100%" viewBox="0 0 40 70" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="38" height="68" rx="2" fill="#E2E8F0" stroke="#475569" strokeWidth="1" />
        <rect x="4" y="4" width="32" height="62" rx="1" fill="#D1FAE5" fillOpacity="0.5" />

        {/* Texts centered using textAnchor middle */}
        ...
        {/* Center Emblem & Text - Perfectly Centered */}
        <circle cx="20" cy="35" r="14" stroke="#10B981" strokeWidth="0.5" fill="white" fillOpacity="0.8" />
        {/* Using dominantBaseline middle and textAnchor middle for true center */}
        <text x="20" y="36" fontFamily="sans-serif" fontSize="20" fontWeight="bold" fill="#047857" textAnchor="middle" dominantBaseline="middle">₹</text>

        <line x1="2" y1="50" x2="38" y2="50" stroke="#10B981" strokeWidth="1.5" strokeDasharray="4 2" />
        <path d="M2 24H38M2 46H38" stroke="#94A3B8" strokeWidth="0.5" />
    </svg>
);
