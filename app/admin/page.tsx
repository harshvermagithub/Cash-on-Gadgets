    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-card dark:bg-white/[0.03] dark:backdrop-blur-xl border border-border dark:border-white/10 rounded-xl shadow-sm hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.08)] transition-all duration-300 flex items-center gap-4">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link href="/admin/category/tablet" className="p-6 bg-card dark:bg-white/[0.03] dark:backdrop-blur-xl border border-border dark:border-white/10 rounded-xl hover:bg-muted/50 dark:hover:bg-white/[0.06] hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.12)] transition-all duration-300 flex flex-col gap-2">
                        <div className="flex items-center gap-2 font-semibold">
                    ...
                    <Link href="/admin/category/laptop" className="p-6 bg-card dark:bg-white/[0.03] dark:backdrop-blur-xl border border-border dark:border-white/10 rounded-xl hover:bg-muted/50 dark:hover:bg-white/[0.06] hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.12)] transition-all duration-300 flex flex-col gap-2">
                        <div className="flex items-center gap-2 font-semibold">
                    ...
                    <Link href="/admin/riders" className="p-6 bg-card dark:bg-white/[0.03] dark:backdrop-blur-xl border border-border dark:border-white/10 rounded-xl hover:bg-muted/50 dark:hover:bg-white/[0.06] hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.12)] transition-all duration-300 flex flex-col gap-2">
                        <div className="flex items-center gap-2 font-semibold">
                    ...
                    <Link href="/admin/orders" className="p-6 bg-card dark:bg-white/[0.03] dark:backdrop-blur-xl border border-border dark:border-white/10 rounded-xl hover:bg-muted/50 dark:hover:bg-white/[0.06] hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.12)] transition-all duration-300 flex flex-col gap-2">
                        <div className="flex items-center gap-2 font-semibold">
